...
export function ProfilSekolahModal({
  ...
  const [customAbkInput, setCustomAbkInput] = useState<string>("Tunanetra (Low Vision)");
  ...
  const KEKHUSUSAN_LIST = [
    ...
    { kode: "C", nama: "Kelas Tunanetra (C)", ringkas: "Tunanetra", abk: "Tunanetra (Total)", desc: "Hambatan intelektual (ringan–sedang)" },
    { kode: "D", nama: "Kelas Tunadaksa (D)", ringkas: "Tunadaksa", abk: "Tunadaksa", desc: "Hambatan fisik/motorik" },
    { kode: "Tunanetra", nama: "Kelas Spektrum Tunanetra", ringkas: "Tunanetra", abk: "Tunanetra (Low Vision)", desc: "Penanganan & kurikulum adaptif" },
                  ...
                  <div
                    ...
                    <div className="pt-0.5">
                      ...
                      <select
                        ...
                        <option value="Tunanetra (Low Vision)">Tunanetra (Low Vision) (ASD)</option>
                        <option value="Tunarungu">Tunarungu / Wicara</option>
                        <option value="Tunadaksa">Tunadaksa (Fisik/Motorik)</option>
                        <option value="Tunanetra (Total)">Tunanetra (Total)</option>
                        <option value="Tunarungu (Hard of Hearing)">Tunarungu (Hard of Hearing)</option>
